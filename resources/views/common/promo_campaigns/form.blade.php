...
{{--						</div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-0">
                                ...
                                <ui-select remove-selected="false" multiple ng-model="form.products">
                                    <ui-select-match placeholder="Chọn hàng hóa">
                                        <% $item.name %>
                                    </ui-select-match>
                                    <ui-select-choices repeat="item.id as item in (form.products | filter: $select.search)">
                                        <span ng-bind="item.name"></span>
                                    </ui-select-choices>
                                </ui-select>                            </div>
                            <span class="invalid-feedback d-block" role="alert">
