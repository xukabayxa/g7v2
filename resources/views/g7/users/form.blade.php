						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group custom-group">
									...
									<input class="form-control" type="text" ng-model="form.name"  ng-disabled="form.mode == 'edit'" disabled>
									<span class="invalid-feedback d-block" role="alert">
							...
							<div class="col-md-6 mb-3">
								<div class="form-group custom-group" >
									...
									<input class="form-control" type="text" ng-model="form.email" ng-disabled="form.mode == 'edit'" disabled>
									<span class="invalid-feedback d-block" role="alert">
