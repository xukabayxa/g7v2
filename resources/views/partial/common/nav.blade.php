...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" ng-controller="Notification">
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item d-sm-inline-block mr-3">
			<a href="{{ route('Bill.create') }}" class="btn btn-success btn-block btn-quick"><i class="fa fa-shopping-cart d-none d-sm-inline-block"></i> Hóa đơn</a>
		</li>
		<li class="nav-item d-sm-inline-block mr-3">
			<a href="{{ route('ReceiptVoucher.index') }}" class="btn btn-primary btn-block btn-quick"><i class="fa fa-hand-holding-usd d-none d-sm-inline-block"></i> Phiếu thu</a>
		</li>
		<li class="nav-item d-none d-sm-inline-block">
			<a href="{{ route('PaymentVoucher.index') }}" class="btn btn-warning btn-block btn-quick"><i class="fa fa-hand-holding-usd"></i> Phiếu chi</a>
		</li>
		@endif
	</ul>
	<!-- SEARCH FORM -->
	...
	<ul class="navbar-nav ml-auto">
		...
		{{-- <li class="nav-item dropdown" ng-cloak>
			<a class="nav-link" data-toggle="dropdown" href="#">
				...
				<span class="badge badge-warning navbar-badge" style="font-size: 16px">
					<% unread %>
				</span>
			</a>
