...
<script>
    class Bill extends BaseClass {
        ...
        get point_pay() {
            return this._point_pay || 0;
        }

        set point_pay(value)
        {
            this._point_pay = Number(value);
        }

        get point_money()
        {
            return this.point_pay ? (this.point_pay * this.point_rate).toLocaleString('en') : 0;
        }
        ...
        get service_total_point() {
            return this.list_services.reduce((acc, cur) => acc + cur.points, 0);
        }
        ...
        get product_total_point() {
            return this.list_products.reduce((acc, cur) => acc + cur.points, 0);
        }
        ...
        get submit_data() {
            return {
                ...
                service_total_point: this.service_total_point,
                product_total_cost: this.product_total_cost,
                product_total_point: this.product_total_point,
