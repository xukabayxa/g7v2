...
<head>
    ...
    <title>@yield('page_title') - G7 AutoCare Manager</title>
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse layout-navbar-fixed layout-footer-fixed " ng-app="App">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-dark-orange">
            ...
            @endif
            @if(Auth::user()->type == 4)
            @include('partial.common.g7_group_sidebar')
            @endif
            <!-- /.sidebar -->
        </aside>
    ...
    <script type="text/javascript">
        ...
        const SUPPLIER = @json(\App\Model\G7\Supplier::getForSelect());
        const CUSTOMERS = @json(\App\Model\Common\Customer::getForSelect());
        @endIf
    </script>
