...
class PromoCampaign extends BaseModel
{
    ...
    public const TYPES = [
        1 => 'Chiết khấu hóa đơn',
        2 => 'Tặng sản phẩm theo hóa đơn',
        3 => 'Mua hàng tặng hàng'
    ];
    ...
    {
        return $this->belongsToMany(Product::class, PromoCampaignProduct::class, 'promo_campaign_id', 'product_id');
    }

    public function canEdit()
    {
        return in_array(Auth::user()->type, [User::SUPER_ADMIN, User::UPTEK]) || Auth::user()->g7_id == $this->user_create->g7_id;
    }
