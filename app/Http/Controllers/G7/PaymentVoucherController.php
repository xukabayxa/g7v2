	...
	public function store(Request $request)
	{
		$validate = Validator::make(
			...
			[
                ...
                'recipient_id'  => 'required_if:recipient_type_id,1,2,3',
				'supplier_id' => 'required_if:payment_voucher_type_id,1|exists:suppliers,id',
				'ware_house_import_id' => 'required_if:payment_voucher_type_id,1',
				'value' => 'required|integer',
				'pay_type' => 'required|in:1,2',
				'note' => 'max:255',
				'month' => 'nullable|required_if:payment_voucher_type_id,5|integer',
				'g7_fixed_asset_import_id' => 'nullable|required_if:payment_voucher_type_id,2',
			]
		);
		$json = new stdClass();
		...
		try {
			...
			if($object->payment_voucher_type_id == 1) {
				$object->ware_house_import_id = $request->ware_house_import_id;
			}
			if($object->payment_voucher_type_id == 2) {
			...
			if($object->ware_house_import_id && $object->payment_voucher_type_id == 1) {
			...
			if($object->g7_fixed_asset_import_id && $object->payment_voucher_type_id == 2) {
